...
export default function LandingScreen({ initialMode = 'hero', prefillShopName = '', onLoginSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-gradient-to-br from-slate-50 via-white to-indigo-50/50 flex items-center justify-center p-4 font-sans overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-indigo-500/15 blur-[120px] rounded-full" />
        <div className="absolute -bottom-[10%] -right-[10%] w-[40%] h-[40%] bg-fuchsia-500/15 blur-[120px] rounded-full" />
      </div>
      ...
      <AnimatePresence mode="wait">
        {mode === 'hero' && (
          ...
          >
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-950 via-indigo-950 to-fuchsia-950">
              BOUTIDIDACT
            </h1>

            <p className="text-base sm:text-xl md:text-2xl text-slate-650 font-medium max-w-2xl mx-auto mb-10 md:mb-12 leading-relaxed px-4 md:px-0">
              L'intelligence artificielle qui transforme votre point de vente en une expérience{' '}
              <span className="text-indigo-600 font-extrabold">futuriste</span> et <span className="text-fuchsia-600 font-extrabold">automatisée</span>.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 px-4 md:px-0">
              <button
                ...
                className="w-full md:w-auto group px-8 py-4 md:py-5 bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white rounded-2xl font-black text-base md:text-lg transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-indigo-500/25"
              >
                Activer ma borne
              ...
              <button
                ...
                className="w-full md:w-auto px-8 py-4 md:py-5 bg-white text-slate-700 border border-slate-200 rounded-2xl font-black text-base md:text-lg transition-all hover:bg-slate-50 hover:text-slate-900 active:scale-95 shadow-sm"
              >
                Déjà client
              </button>
            </div>
            ...
            <button
              ...
              className="mt-8 md:mt-10 inline-flex items-center gap-2 text-slate-400 hover:text-red-500 text-xs md:text-sm font-bold transition-colors"
            >
        ...
        {(mode === 'pricing' || mode === 'signup' || mode === 'login') && (
          ...
          >
            <button
              ...
              className="absolute -top-12 md:-top-16 left-4 md:left-0 flex items-center gap-2 text-slate-500 hover:text-slate-900 font-bold transition-colors"
            >
              <ArrowLeft size={20} />
              Retour
            </button>

            <div className="bg-white/85 backdrop-blur-xl border border-slate-200 rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 shadow-2xl overflow-y-auto max-h-[80vh] md:max-h-none custom-scrollbar">
              {mode === 'pricing' && (
        ...
        {mode === 'delete' && (
          ...
          >
            <button
              ...
              className="absolute -top-16 left-0 flex items-center gap-2 text-slate-500 hover:text-slate-950 font-bold transition-colors"
            >
              <ArrowLeft size={20} />
              Retour
            </button>

            <div className="bg-white/85 backdrop-blur-xl border border-red-200 rounded-[3rem] p-8 md:p-12 shadow-2xl">
              {deleteSuccess ? (
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 mt-2">
                      Cette action est <strong className="text-red-650 font-extrabold">définitive</strong>. L'abonnement Stripe sera annulé et toutes les données locales seront effacées.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={submitting}
                      className="w-full py-5 bg-red-650 hover:bg-red-700 text-white rounded-2xl font-black text-lg transition-all active:scale-[0.98] disabled:opacity-50 mt-4 flex items-center justify-center gap-3"
                    >
...
function WaitingPanel({ onContinue }) {
  ...
  return (
    ...
    >
      <div className="bg-white/85 backdrop-blur-xl border border-slate-200 rounded-[3rem] p-10 md:p-14 shadow-2xl text-center">
        <motion.div
          initial={{ scale: 0 }} animate={{ scale: 1 }}
          transition={{ type: 'spring', damping: 12 }}
          className="w-20 h-20 bg-emerald-50 border border-emerald-200 text-emerald-600 rounded-3xl flex items-center justify-center mx-auto mb-6"
        >
          <Inbox size={40} />
        </motion.div>
        ...
        <p className="text-slate-650 leading-relaxed mb-8">
          ...
          <strong className="text-slate-900 font-extrabold">mot de passe</strong> choisi à l'inscription, puis renseignez vos identifiants Boutididact dans les paramètres.
        </p>
...
function PricingFeature({ text }) {
  return (
    <div className="flex items-center gap-3 text-slate-700">
      <div className="w-6 h-6 rounded-full bg-emerald-55/15 border border-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
        <Check size={14} />
      </div>
